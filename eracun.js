...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    if (!napaka1 && !napaka2)
      sporociloRegistracija = "Stranka je bila uspešno registrirana.";
    else {
      sporociloRegistracija = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
...
streznik.get('/prijava', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: sporociloRegistracija, seznamStrank: stranke, seznamRacunov: racuni});  
      }) 
    });
})
